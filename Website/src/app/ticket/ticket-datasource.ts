...
export class TicketDataSource extends DataSource<TicketItem> {
   ...
   */
  private getPagedData(data: TicketItem[]): TicketItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TicketItem[]): TicketItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        case 'name': return compare(a.homeTeam, b.homeTeam, isAsc);
        case 'id': return compare(+a.awayTeam, +b.awayTeam, isAsc);
        default: return 0;
      }
    });
  }
