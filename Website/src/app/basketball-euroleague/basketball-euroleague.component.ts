...
import { BasketballEuroleagueDataSource, BasketballEuroleagueItem } from './basketball-euroleague-datasource';

@Component({
  selector: 'basketball-euroleague',
  templateUrl: './basketball-euroleague.component.html',
  styleUrls: ['./basketball-euroleague.component.css']
})
export class BasketballEuroleagueComponent implements AfterViewInit {
  @ViewChild(MatPaginator) paginator!: MatPaginator;
  @ViewChild(MatSort) sort!: MatSort;
  @ViewChild(MatTable) table!: MatTable<BasketballEuroleagueItem>;
  dataSource: BasketballEuroleagueDataSource;
  toggle = true;
  ...
  constructor(private matchService: MatchService, private toastr: ToastrService, private ticketService: TicketService) {
    this.dataSource = new BasketballEuroleagueDataSource();
  }
  ...
  ngAfterViewInit(): void {
    ...
    this.getBasketballEuroleague();
    this.getTicketData();
  }

  //GET data and populate data table with response
  getBasketballEuroleague(){
    this.matchService.getBasketballEuroleague()
    .subscribe(
      response => {
